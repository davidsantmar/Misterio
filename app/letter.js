...
export default function Letter() {
  ...
  return (
    <ImageBackground
      ...
      source={require("../assets/images/letter-back.png")}
    >
      <View style={styles.textContainer}>
        <View style={{ transform: [{ rotate: "3deg" }] }}>
          <Text style={styles.letterText}>
            Le contactamos para encargarle la investigación del misterio del
            castillo de Transilvania. Un excéntrico aristócrata y la servidumbre
            que allí vivía han desaparecido en extrañas circunstancias. Los
            únicos datos que se tienen están basados en leyendas y
            supersticiones de las gentes del lugar, sobre los monstruos que
            habitan en el castillo y que en las noches de luna llena regresan, y
            atacan a todo aquel que ose vivir o pasar por allí.
          </Text>
        </View>
        <View style={styles.signatureContainer}>
          <Text style={styles.signatureTitle}>La Talamasca</Text>
